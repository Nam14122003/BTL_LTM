...
public class SocketHandler {
    ...
    public void onReceiveGameEvent(String received) {
        ...
        switch (gameEventType) {
            ...
            case MOVE:
                ...
                RunClient.inGameScene.addPoint(row, column, _user);
                RunClient.inGameScene.changeTurnFrom(_user);
                break;

            case WIN:
                String winUser = splitted[2];
                RunClient.inGameScene.setWin(winUser);
                break;
            ...
            case TURN_TIMER_END:
                ...
                RunClient.inGameScene.setWin(winnerUser);
                break;
    ...
    public void signup(String username, String password, String name, String gender, int yearOfBirth, String avatar) {
        // prepare data
