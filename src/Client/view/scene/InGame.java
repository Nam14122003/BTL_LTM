...
public class InGame extends javax.swing.JFrame {
        ...
        lListUser.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (evt.getClickCount() == 2) {
                    ...
                    RunClient.profileScene.loadProfileData(listPlayersModel.get(index).getUser());
                }
            }
        });
    ...
    public void setWin(String winUser) {
        ...
        // get myUser
        String myUser = RunClient.socketHandler.getLoginUser();

        if (winUser.equals(myUser)) {
        ...
        } else if (myUser.equals(player1.getUser()) || myUser.equals(player2.getUser())) {
            // nếu mình là 1 trong 2 người chơi, mà winUser ko phải mình => thua
