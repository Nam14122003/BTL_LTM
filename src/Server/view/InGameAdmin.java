 ...
 */
public class InGameAdmin extends javax.swing.JFrame {
...
//                    Admin.openScene(Admin.SceneName.PROFILE);
//                    Admin.profileScene.loadProfileData(listPlayersModel.get(index).getUser());
                }
            }
        });
        ...
        this.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
                if (JOptionPane.showConfirmDialog(InGameAdmin.this,
    ...
    public void setWin(String winUser) {
        // pause timer
        matchTimer.pause();
        turnTimer.pause();
        ...
        String nameId = "";
        if (player1.getUser().equals(winUser)) {
    ...
    // change turn sang cho username đầu vào
    public void setTurn(String username) {
        if (player1.getUser().equals(username)) {
            turnTimer.restart();
            turn = 1;
        ...
        if (player2.getUser().equals(username)) {
            turnTimer.restart();
            turn = 2;
            lbActive1.setVisible(false);
    ...
    // change turn sang cho đối thủ của username đầu vào
    public void changeTurnFrom(String username) {
        if (username.equals(player1.getUser())) {
            setTurn(player2.getUser());
        } else {
            setTurn(player1.getUser());
        }
    }
    ...
    public void addPoint(int row, int column, String username) {
        ...
        lastMove.setActionCommand(username); // save username as state

        if (username.equals(player1 != null ? player1.getUser() : "")) {
    ...
    public void clickOnBoard(int row, int column) {
        String myUser = Admin.joinRoom.getLoginUser();

        if (myUser.equals(player1.getUser()) || myUser.equals(player2.getUser())) {
            Admin.joinRoom.move(row, column);
        }
    }
        ...
        b.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (b.getActionCommand().equals("")) {
                    ...
                    if (myUser.equals(player1.getUser()) && (turn == 1 || turn == 0)) {
                        b.setIcon(p1Icon);
                    }

                    if (myUser.equals(player2.getUser()) && (turn == 2 || turn == 0)) {
                        b.setIcon(p2Icon);
                    }
                }
            }
    ...
    private void btnSendMessageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSendMessageMouseClicked
        ...
        if (!chatMsg.equals("")) {
            Admin.joinRoom.chatRoom(chatMsg);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InGameAdmin.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InGameAdmin().setVisible(true);
            }
        });
    }
